...
namespace PrettifyStudio\Twitter\Contract;

use PrettifyStudio\Twitter\Contract\Http\AsyncClient;
use PrettifyStudio\Twitter\Contract\Http\Client as HttpClient;
use PrettifyStudio\Twitter\Contract\Http\SyncClient;
