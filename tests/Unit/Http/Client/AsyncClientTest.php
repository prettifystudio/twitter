...
namespace PrettifyStudio\Twitter\Tests\Unit\Http\Client;

use PrettifyStudio\Twitter\Contract\Http\AsyncClient as AsyncClientContact;
use PrettifyStudio\Twitter\Exception\TwitterException;
use PrettifyStudio\Twitter\Http\Client\AsyncClient;
use PrettifyStudio\Twitter\Http\Factory\BrowserCreator;
...
/**
 * @coversDefaultClass \PrettifyStudio\Twitter\Http\Client\AsyncClient
 */
final class AsyncClientTest extends TestCase
{
     ...
     * @covers \PrettifyStudio\Twitter\Http\Client::__construct
     * @covers \PrettifyStudio\Twitter\Http\Client::logRequest
     *
     * @throws Exception
     */
     ...
     * @covers \PrettifyStudio\Twitter\Http\Client::__construct
     * @covers \PrettifyStudio\Twitter\Http\Client::logRequest
     * @covers \PrettifyStudio\Twitter\Http\Client::deduceClientException
     *
     * @throws Exception
     */
